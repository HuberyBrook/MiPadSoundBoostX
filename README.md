...
小米平板 Magisk 音效增强模块集合。

## 模块列表

| 模块 | 适配机型 | 更新时间 |
|------|---------|---------|
| MiPadSoundBoostX_Dagu | Pad 5 Pro 12.4 (dagu) | 2025-10-05 |
...
1. Magisk / KernelSU 管理器 → 模块 → 从本地安装
2. 选择对应机型的 zip 包
3. 重启设备
...
- 请确认选择与设备代号匹配的模块
- 设备代号可通过 `getprop ro.product.device` 或 Magisk 主页面查看
